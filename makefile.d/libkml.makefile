...
libkml.installed: libkml curl.installed zlib.installed
	cd libkml && \
	$(call cmake,\
	-DCMAKE_C_FLAGS="-I$(INSTALL_DIR)/include" \
	-DCMAKE_CXX_FLAGS="-I$(INSTALL_DIR)/include")

#	cmake -G "Unix Makefiles" -DCMAKE_INSTALL_PREFIX=$(INSTALL_DIR) -DCMAKE_C_COMPILER=gcc -DCMAKE_CXX_COMPILER=g++ -DCMAKE_C_FLAGS=-I$(INSTALL_DIR)/include -DCMAKE_CXX_FLAGS=-I$(INSTALL_DIR)/include . && $(MAKE) && $(MAKE) install && touch ../$@
